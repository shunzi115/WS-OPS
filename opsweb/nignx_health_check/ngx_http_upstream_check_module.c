    ...
    ngx_http_upstream_check_peers_t *peers, ngx_uint_t flag)
{
    ...
    b->last = ngx_snprintf(b->last, b->end - b->last,
            ...
            "  <title>莴笋健康检查</title>\n"
            "  <meta charset=\"utf-8\">\n"
            "  <link rel=\"shortcut icon\" href=\"https://image.watsons.com.cn/wosun_icon_20180425162015.png\" type=\"image/x-icon\">\n"
            "  <link href=\"https://cdn.bootcss.com/bootstrap/3.3.7/css/bootstrap.min.css\" rel=\"stylesheet\">\n"
            "</head>\n"
            "<body>\n"
            "<div class=\"row\" style=\"background: #d9edf7\">\n"
            "  <div class=\"col-sm-8 col-sm-offset-2 border-bottom white-bg dashboard-header\" style=\"min-height:100%\">\n"
            "    <h1 class=\"text-center\">莴笋应用健康检查</h1>\n"
            "    <h3 class=\"text-center\">应用数量: %ui , Nginx重启次数: %ui</h3>\n"
            "    <table class=\"table table-striped table-bordered table-hover\" style=\"background-color:white\" cellspacing=\"0\" "
    ...
    for (i = 0; i < peers->peers.nelts; i++) {
        ...
        b->last = ngx_snprintf(b->last, b->end - b->last,
                ...
                "    <td class=\"text-center\">%ui</td>\n"
                "  </tr>\n",
                peer[i].shm->down ? " style=\"background-color: red\"" : "",
                i,
